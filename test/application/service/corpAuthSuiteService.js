...
describe('corpAuthSuite service use case test', function () {
    var service;
    before(function () {
    ...
    describe('#getAuthCorpSuiteInfo(suiteID, authCode, callback)', function () {
        context('get auth corp suite info', function () {
            it('is success if all is ok ', function (done) {
                var mockRequest = function (options, callback) {
                    callback(null, {}, {
                ...
                service.getAuthCorpSuiteInfo(suiteID, authCode, function (err, authCorpSuiteInfoData) {
